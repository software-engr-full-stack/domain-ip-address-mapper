...
type Model struct {
    ...
    IPs        []ip.Model        `json:"ips" gorm:"foreignKey:ParentDataID;constraint:OnDelete:CASCADE;"`
    Error      error             `json:"error" gorm:"-"`

    SubDomains []subdomain.Model `json:"sub_domains" gorm:"foreignKey:ParentID;constraint:OnDelete:CASCADE;"`
